package com.opcoach.rcpa.rental.ui;
...
public class RentalUIActivator extends AbstractUIPlugin implements  RentalUIConstants
{
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.opcoach.rcpa.rental.ui";
	...
	public void readColorProviderExtensions()
	{
		...
		IExtensionPoint extp = reg.getExtensionPoint("com.opcoach.rcpa.rental.ui.Palette");
